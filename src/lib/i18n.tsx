...
const en = {
  ...
  retry: "Retry",
  updateBusyMessage: "Finish the current test before installing the update.",
  updateNotes: "What's new",
  noUpdateNotes: "No release notes were provided.",
  ...
  standardBidirectionalDuration: "{{seconds}}s each",
  protocol: "Protocol",
  direction: "Direction",
  upload: "Upload",
  download: "Download",
  ...
  udpReceivedRate: "UDP received throughput",
  ...
  senderSampleCount: "{{count}} sender samples",
  deviceA: "Device A",
  ...
  senderAverage: "Sender average",
  receiverAverage: "Receiver average",
  peak: "Peak",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  checkForUpdates: "检查更新", checkingForUpdates: "正在检查更新…", upToDate: "当前已是最新版本",
  updateAvailable: "发现版本 {{version}}", updateDialogTitle: "发现新版本", currentVersion: "当前版本 {{version}}",
  newVersion: "新版本 {{version}}", updateAndRestart: "更新并重新启动", openDownloadPage: "打开下载页面",
  downloadingUpdate: "正在下载更新…", downloadProgress: "已下载 {{percent}}%", installingUpdate: "正在安装更新…",
  updateCheckFailed: "无法检查更新", updateInstallFailed: "更新失败，请重试", retry: "重试",
  updateBusyMessage: "请先结束当前测速，再安装更新。", updateNotes: "更新内容", noUpdateNotes: "此版本未提供更新说明。",
  ...
  bidirectionalDuration: "上下行各 {{seconds}} 秒", standardBidirectionalDuration: "双向 {{seconds}} 秒",
  protocol: "协议", direction: "方向", upload: "上传", download: "下载",
  parallelStreams: "并发线程", duration: "持续时间", rateLimit: "限速", unlimited: "无限速", limited: "有限速",
  targetRate: "总目标速率", megabitsPerSecond: "Mbps", continuous: "持续", seconds: "秒", startFullTest: "开始完整测试",
  ...
  udpSendRate: "UDP 发送速率", udpReceivedRate: "UDP 接收吞吐",
  downloadSpeed: "下行速率", bandwidthUnit: "速率单位", thisDevice: "本机", localClient: "本机客户端", deviceA: "设备 A",
  remoteClient: "远端客户端", result: "结果", standby: "待机", sampleCount: "{{count}} 个采样", senderSampleCount: "{{count}} 个发送端采样",
  ...
  averageSpeed: "平均速率", senderAverage: "发送端平均", receiverAverage: "接收端平均", peak: "峰值", packetLoss: "丢包率", udpJitter: "UDP 抖动", rttVariation: "RTT 波动",
  transferRetransmits: "传输 / 重传", transferred: "已传输", sent: "已发送", received: "已接收", later: "稍后处理", copied: "已复制", copyCommand: "复制命令",

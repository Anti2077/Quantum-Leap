...
const en = {
  ...
  healthScore: "Link health",
  healthDiagnostics: "Link diagnostics",
  closeHealthDiagnostics: "Close link diagnostics",
  healthConfidenceFull: "Complete data",
  healthConfidencePartial: "Partial data",
  healthConfidenceInsufficient: "Insufficient data",
  healthHealthy: "Healthy",
  healthGood: "Good",
  healthAttention: "Needs attention",
  healthPoor: "Poor",
  healthUnknown: "Unavailable",
  healthMetricGood: "Good",
  healthMetricAttention: "Watch",
  healthMetricPoor: "Poor",
  healthMetricUnknown: "Not captured",
  healthRetransmission: "TCP retransmission",
  healthPacketLoss: "UDP packet loss",
  healthLoadedLatency: "Loaded latency increase",
  healthLatencyStability: "RTT stability",
  healthUdpJitter: "UDP jitter",
  healthTransferStability: "Transfer stability",
  healthRetransmissionValue: "{{density}} / GiB · {{affected}}% intervals",
  healthPacketLossValue: "{{loss}}% · {{lost}} packets lost",
  healthLoadedLatencyValue: "+{{increase}} ms · {{baseline}} ms idle",
  healthLatencyStabilityValue: "P95-P50 {{spread}} ms · {{median}} ms median",
  healthUdpJitterValue: "{{jitter}} ms",
  healthTransferStabilityValue: "P10 / median {{ratio}}%",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  healthScore: "链路健康", healthDiagnostics: "链路诊断", closeHealthDiagnostics: "关闭链路诊断",
  healthConfidenceFull: "数据完整", healthConfidencePartial: "部分数据", healthConfidenceInsufficient: "数据不足",
  healthHealthy: "健康", healthGood: "良好", healthAttention: "需要关注", healthPoor: "较差", healthUnknown: "无法评估",
  healthMetricGood: "良好", healthMetricAttention: "关注", healthMetricPoor: "较差", healthMetricUnknown: "未获取",
  healthRetransmission: "TCP 重传", healthPacketLoss: "UDP 丢包", healthLoadedLatency: "负载延迟增长",
  healthLatencyStability: "RTT 稳定性", healthUdpJitter: "UDP 抖动", healthTransferStability: "传输稳定性",
  healthRetransmissionValue: "{{density}} 次/GiB · {{affected}}% 区间发生",
  healthPacketLossValue: "{{loss}}% · 丢失 {{lost}} 个包", healthLoadedLatencyValue: "+{{increase}} ms · 空闲 {{baseline}} ms",
  healthLatencyStabilityValue: "P95-P50 {{spread}} ms · 中位 {{median}} ms", healthUdpJitterValue: "{{jitter}} ms",
  healthTransferStabilityValue: "P10 / 中位数 {{ratio}}%", udpPacketLoss: "UDP 丢包",
  ...
  notConnected: "未连接", remoteServer: "远端服务器", live: "实时", uploadAverage: "上传平均",

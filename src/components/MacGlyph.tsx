  ...
  return (
    <div className={`local-node ${active ? "is-active" : ""}`}>
      <div className="mac-shell">
        <span className="mac-orbit orbit-one" aria-hidden="true" />
        <span className="mac-orbit orbit-two" aria-hidden="true" />
        ...
        <span className="mac-port" aria-hidden="true"><i /><i /></span>
        <span className="mac-dock-wave" aria-hidden="true" />
      </div>
